...
xcopy /hrkys /exclude:exclude_files_2.txt bin\32\Release\mod_loader*.* dist\module\mod_loader_32.*
...
xcopy /hrkys /exclude:exclude_files_2.txt bin\64\Release\mod_loader*.* dist\module\mod_loader_64.*
...
xcopy /hrkys /exclude:exclude_files_2.txt bin\32\Release\mod_loader*.* dist\with_runtime\mod_loader_32.*
...
xcopy /hrkys /exclude:exclude_files_2.txt bin\64\Release\mod_loader*.* dist\with_runtime\mod_loader_64.*
