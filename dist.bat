...
xcopy /hrkys /exclude:exclude_files_2.txt bin\32\Release\loader.* dist\module\ffxiv_mod.*
...
xcopy /hrkys /exclude:exclude_files_2.txt bin\64\Release\loader.* dist\module\ffxiv_dx11_mod.*
...
xcopy /hrkys /exclude:exclude_files_2.txt bin\32\Release\loader.* dist\with_runtime\ffxiv_mod.*
...
xcopy /hrkys /exclude:exclude_files_2.txt bin\64\Release\loader.* dist\with_runtime\ffxiv_dx11_mod.*
